...
# ══════════════════════════════════════════════════
# ── FORECASTING METHODS (6 methods, all Excel-verifiable)
# ══════════════════════════════════════════════════
...
def run_wma(values, horizon, window=3):
    """Weighted Moving Average: weights 1,2,3 (most recent = highest)."""
...
def run_ses(values, horizon):
    """Single Exponential Smoothing: one parameter α, level only."""
...
def run_des(values, horizon):
    """Double Exponential Smoothing: level + trend (α, β)."""
...
def run_linear_seasonal(values, horizon, seasonal_periods=12):
    """Linear Regression + Seasonal Dummies: trend + 11 monthly dummies."""
    n = len(values)
...
# Method registry: key → (display name, function)
METHODS = {
